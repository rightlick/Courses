...
Задание 46
Посмотрите на код программы, которая обрабатывает поисковый запрос. Отметьте константными все ссылки, которые должны ими быть. 
Попробуйте изменить объекты по полученным константным ссылкам. Сообщение об ошибке будет выглядеть знакомо.
*/

...
Задание 22
Перед вами код игры. Игрок должен вводить число, пытаясь угадать его. Верный ответ — 5. 
Если число 5 угадано, программа выводит "You are right!". Если пользователь ошибся, программа выводит "Guess the number: ".
